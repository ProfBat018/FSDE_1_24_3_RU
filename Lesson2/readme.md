...
Во первых при создании базы данных создаются два файлв с расширением `.mdf`(main database file) и `.ldf`(log database file). Вот пример хранения данных в базе данных.
