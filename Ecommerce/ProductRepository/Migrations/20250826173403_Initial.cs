        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductWarehouseId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hubs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Hubs_ProductWarehouses_ProductWarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hubs_ProductWarehouseId",
                table: "Hubs",
